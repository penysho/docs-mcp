...
import { DocumentSearchResult } from '../services/types.js';
...
export interface IGoogleDocsService {
  ...
  updateDocumentContent(documentId: string, content: string, startPosition?: number, endPosition?: number): Promise<void>;
  searchForDocuments(query: string, maxResults?: number): Promise<DocumentSearchResult[]>;
}
